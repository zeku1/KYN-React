          ...
          <div className="hero min-h-screen bg-forrest-200">
            <div className="hero-content flex-col lg:flex-row-reverse">
              <div className="text-center lg:text-left">
                ...
                <p className="py-6">Register to Know Your Neighborhood to see the stores around you. </p>
              </div>
              ...
              <div className="flex justify-center mt-10 text-white ">
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="btn py-3 mt-3 rounded-md border-orange-500 text-slate-500 bg w-full"
                    >
                      Register
                    </button>
                  </form>
