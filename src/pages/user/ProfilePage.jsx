...
const ProfilePage = () => {
  ...
  return (
    <StoreLayout>
      <div className="flex justify-center w-full md:max-w-[700px] mt-8 py-4 px-5 rounded-lg bg-base-300">
        <img
          src={userDefault}
          alt="profile_picture"
          className="rounded-full mask  ring ring-orange-600 ring-offset-base-100 ring-offset-2
            w-24 h-24 sm:w-40 sm:h-40 mr-5"
        />
        <div className="mt-2 font-inter font-medium text-gray-400 w-full">
          <h3 className="text-2xl md:text-3xl text-orange-500 mb-1 pb-2 border-b">
            {userProfile.name}
          </h3>
          <div className="grid grid-cols-1 gap-2">
            ...
            <div>
              <p className="text-orange-500">Phone Number</p>
