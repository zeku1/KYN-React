...
const ViewStorePage = () => {
  ...
  return (
    <StoreLayout>
      <div className="flex justify-between flex-col sm:flex-row my-5 py-5 bg-forrest">
        <Link
          to="/stores/add"
          className="btn btn-orange-500 bg bg-orange-500 flex items-center space-x-2 font-medium text-primary text-lg mb-3 ml-1 sm:mb-0 sm:ml-0"
        >
