...
const StoreCard = ({ store }) => {
  ...
  return (
    <div className="shadow-lg overflow-hidden rounded-md border border-orange-500">
      <img
        src={store2}
        alt="store"
      ...
      <Link
        ...
        className="block py-3 border border-orange-500 bg-color1 font-semibold text-center mt-3"
      >
        Show Detail
      </Link>
    </div>
