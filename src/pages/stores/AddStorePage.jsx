    ...
    <MainLayout>
      <div className="flex justify-center mt-10 text-white">
        <form
          ...
          className="p-[30px] bg-forrest-300 w-full max-w-[500px] rounded-lg"
        >
          ...
          <button
            type="submit"
            className="py-3 mt-3 rounded-md border border-orange-500 btn text-primary bg-base-200 w-full"
          >
            Add Store
          </button>
        </form>
